...
(
    ...
    phone_number_confirm  BOOLEAN                                 NOT NULL,
    email        VARCHAR(255),
    email_confirm         BOOLEAN                                 NOT NULL,
    country      VARCHAR(255),
    favorite_llm VARCHAR(255),
    most_use_llm BIGINT,
    default_llm BIGINT,
...
INSERT INTO t_user (username, password, first_name, last_name, city, phone_number, email, is_active, phone_number_confirm, email_confirm) VALUES ('Admin'::varchar(255), '$2a$10$CoGLxi64srfRe2t6Wxc6rOlCJIl1977Cc.K6ThVZBC3b29XdYnyby'::varchar(255), 'Админ'::varchar(255), 'Админов'::varchar(255), 'Екатеринбург'::varchar(255), null::varchar(255), null::varchar(255), true::boolean, true::boolean, true::boolean);
