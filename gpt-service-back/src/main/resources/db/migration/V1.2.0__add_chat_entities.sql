...
CREATE TABLE t_conversation (
    ...
    CONSTRAINT fk_conversation_user FOREIGN KEY (user_id) REFERENCES t_user(id),
    CONSTRAINT fk_conversation_model FOREIGN KEY (model_id) REFERENCES t_llm_model(id)
);

-- Create message table (for both requests and responses)
